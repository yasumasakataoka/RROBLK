...
("ID", "LOCA_ID", "LOCA_CODE", "LOCA_NAME", "LOCA_ABBR", "LOCA_ZIP", "LOCA_COUNTRY", "LOCA_PRFCT", "LOCA_ADDR1", "LOCA_ADDR2", "LOCA_TEL", "LOCA_FAX", "LOCA_MAIL", "LOCA_REMARK", "LOCA_EXPIREDATE", "LOCA_PERSON_ID_UPD", "PERSON_CODE_UPD", "PERSON_NAME_UPD", "PERSON_EMAIL_UPD",
...
;
 ...
 ("ID", "PERSON_ID", "PERSON_CODE", "PERSON_NAME",
  "PERSON_EMAIL",  loca_code_sect,loca_name_sect,person_EXPIREDATE) AS 
  select person.id,person.id person_id ,person.code person_code,person.name person_name ,
  person.email person_email_chrg , sect.loca_code_sects loca_code_sects_chrg,
 ...
 ("ID", "PERSON_ID","PERSON_CODE",PERSON_EXPIREDATE) AS 
  select  person.id, person.id person_id ,person.code person_code,person.EXPIREDATE person_EXPIREDATE
 from persons person 
 ;
