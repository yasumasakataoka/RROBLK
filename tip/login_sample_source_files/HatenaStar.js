    ...
    addAddButton: function() {
        ...
        var addButtonClass =
            this.constructor.AddButtonClass || (
                (Hatena.Star.useSmartPhoneStar && (b.isIPhone || b.isAndroid || b.isDSi))
...
Hatena.Star.Pallet.SmartPhone = new Ten.Class({
    ...
    PALLET_STYLE: 'top: 0px; left: 0px; width:100px; height:80px; overflow:hidden;' + (Ten.Browser.isIPhone || Ten.Browser.isAndroid ? 'background:transparent;' : ''),
    closeButton: null,
    style: {
        padding: '0px',
        textAlign: 'center',
        border: '0px',
        background: (Ten.Browser.isIPhone || Ten.Browser.isAndroid ? 'transparent' : '')
    },
    containerStyle: {
    ...
    COLOR_SCHEME_DEFINITIONS: {
        dark: {
            backgroundContainerBackground: (Ten.Browser.isIPhone || Ten.Browser.isAndroid ? 'rgba(10, 10, 10, 0.7)' : '#505050'),
            color: 'white',
