class ExcelexportController < ApplicationController
  ...
  def export
    ...
    subpaging  command_r 
	 ...
	 key_color = ws.styles.add_style  :bg_color => 'ffc6b2'    ###薄い赤
	 ##indisp_color = ws.styles.add_style  :bg_color => 'ffff99'  ##薄い黄色
	 indisp_color = ws.styles.add_style  :bg_color =>  'ffc6b2'   #薄い赤
	 input_color = ws.styles.add_style  :bg_color => 'e5ffe5'
	 fcolors = []
         col_type.each do  |j|
